...
--import Qnject.Client exposing (Model, Msg(..), initialModel, view, update, subscriptions, css)
import Html exposing (Html, span, text)
import Html.Attributes exposing (class)
import Html.Events exposing (onClick)
import Qnject.Client
import Qnject.QAppView
import Qnject.Qobject exposing (QApp)
import Task
...
--childUpdate : ChildMsg -> Model -> (ChildModel, QApp, Cmd Msg)
